% AF relay
function [obj,ite,flag]=schemeE(L,K,M,N,PBS,PI,Rth,Eth,sigmaI,sigmaE,deltaI,Amax,lamda,PAF_relay,epsilon,Lmax,R,gr,gd,hr,hd)
    ite=0;
    obj=zeros(1,100);
    ...
    while 1
        ...
        while 1
            ...
            while 1
                ...
                Ptotal_1=PowBS+PowRIS+PAF_relay;
        ...
        while 1
            ...
            while 1
                ...
                expression Ptotal_2 
                expression E2(1,L)
                Ptotal_2=real(quad_form(v,Rw+Rf+deltaI*eye(N))+powBS+PAF_relay);
                for l=1:L
        ...
        Ptotal=pow_BS+pow_RIS+deltaI*norm(diag(v),'fro')^2+PAF_relay;
        ite=ite+1;
