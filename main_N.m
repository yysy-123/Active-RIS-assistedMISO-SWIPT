...
for e=1:EE
    ...
    N=8*e;%number of elements
    AN=24;%nuber of AF relay antennas
    ...
    parfor i=1:LL
        ...
        [objE,iteE,flagE]=schemeE(L,K,M,AN,PBS,PI,Rth,Eth,sigmaI,sigmaE,deltaI,Amax,lamda,PAF_relay,epsilon,Lmax,R,gr,gd,hr,hd);
...
xlabel('Number of ARIS elements');
